...
export const WILAYAS = [
  ...
  "Laghouat", "Lemdiy", "Liban", "Mascara", "Medea", "Mila", 
  ...
  "Tlemcen", "Al-Muhammadia", "Boudouaou", "Bourouba", "Cheraga", "Dar el Beida", 
  "Hussein Dey", "Kolea", "Mahelma", "Mehrouba", "Oued Koriche", "Rouiba", 
  "Saoula"
] as const;
