      ...
      <div className="flex items-center gap-4">
        ...
        <Link href="/" className="flex items-center gap-2">
          <svg 
            ...
            className="flex-shrink-0 opacity-50 hover:opacity-100 transition-opacity duration-200"
          >
          ...
          <span className="hidden sm:block">Cader</span>
        </Link>
      ...
      <div className="flex items-center gap-2">
        ...
        {user ? (
          <div className="relative">
            <DropdownMenu>
              <DropdownMenuTrigger className="flex items-center gap-2 rounded-full p-1 hover:bg-bg-elevated transition-colors">
              ...
              <DropdownMenuContent className="w-[200px]">
                ...
                {/* Help */}
                <DropdownMenuItem>
                  <Link href="/help" className="flex w-full items-center gap-2 px-4 py-2 text-left text-text-primary hover:bg-bg-surface">
                    Help
                  </Link>
                </DropdownMenuItem>
                ...
                {/* Logout */}
                <DropdownMenuItem onClick={handleLogout} className="text-destructive hover:text-destructive/80">
                  Logout
                </DropdownMenuItem>
              </DropdownMenuContent>
            </DropdownMenu>
